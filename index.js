...
const pool = new Pool({
  host: "dpg-d0vf0oumcj7s73ej72d0-a.oregon-postgres.render.com",
  user: "postgre",
  password: "UMYaR3flqT5X0s1Qbxfr2qIETbw8EETS",
  database: "e_commerce_nc7q",
  port: 5432,
  ssl: {
    rejectUnauthorized: false, // Disable certificate verification (OK for development)
  },
});
